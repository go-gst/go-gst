...
//export _goglib_gstcheck1_CheckLogFilterFunc
func _goglib_gstcheck1_CheckLogFilterFunc(carg1 *C.gchar, carg2 C.GLogLevelFlags, carg3 *C.gchar, carg4 C.gpointer) (cret C.gboolean) {
