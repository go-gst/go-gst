...
type RTSPExtension interface {
	...
	// GetTransports wraps gst_rtsp_extension_get_transports
	// 
	// The function takes the following parameters:
	// 
	...
	// 
	// 	- goret RTSPResult 
	GetTransports(RTSPLowerTrans, string) RTSPResult
...
// 
// 	- goret RTSPResult 
func (ext *RTSPExtensionInstance) GetTransports(protocols RTSPLowerTrans, transport string) RTSPResult {
	var carg0 *C.GstRTSPExtension // in, none, converted
	var carg1 C.GstRTSPLowerTrans // in, none, casted
	var carg2 **C.gchar           // in, none, string, casted *C.gchar
	var cret  C.GstRTSPResult     // return, none, casted

	carg0 = (*C.GstRTSPExtension)(UnsafeRTSPExtensionToGlibNone(ext))
	carg1 = C.GstRTSPLowerTrans(protocols)
	carg2 = (**C.gchar)(unsafe.Pointer(C.CString(transport)))
	defer C.free(unsafe.Pointer(carg2))

	cret = C.gst_rtsp_extension_get_transports(carg0, carg1, carg2)
	runtime.KeepAlive(ext)
...
func (msg *RTSPMessage) GetHeader(field RTSPHeaderField, indx int) (string, RTSPResult) {
	...
	var carg2 *C.gchar             // out, none, string, casted *C.gchar, nullable
	var cret  C.GstRTSPResult      // return, none, casted
