...
func (channel *WebRTCDataChannel) Close() {
	...
	_arg0 = (*C.GstWebRTCDataChannel)(unsafe.Pointer(coreglib.BaseObject(channel).Native()))
...
func (ice *WebRTCICE) AddCandidate(stream WebRTCICEStreamer, candidate string, promise *gst.Promise) {
	...
	_arg0 = (*C.GstWebRTCICE)(unsafe.Pointer(coreglib.BaseObject(ice).Native()))
	_arg1 = (*C.GstWebRTCICEStream)(unsafe.Pointer(coreglib.BaseObject(stream).Native()))
...
func (stream *WebRTCICEStream) FindTransport(component WebRTCICEComponent) WebRTCICETransporter {
	...
	_arg0 = (*C.GstWebRTCICEStream)(unsafe.Pointer(coreglib.BaseObject(stream).Native()))
...
func (ice *WebRTCICEStream) GatherCandidates() bool {
	...
	_arg0 = (*C.GstWebRTCICEStream)(unsafe.Pointer(coreglib.BaseObject(ice).Native()))
...
func (ice *WebRTCICETransport) ConnectionStateChange(newState WebRTCICEConnectionState) {
	...
	_arg0 = (*C.GstWebRTCICETransport)(unsafe.Pointer(coreglib.BaseObject(ice).Native()))
...
func (transport *WebRTCICETransport) gatherCandidates() bool {
	...
	_arg0 = (*C.GstWebRTCICETransport)(unsafe.Pointer(coreglib.BaseObject(transport).Native()))
...
func (sender *WebRTCRTPSender) SetPriority(priority WebRTCPriorityType) {
	...
	_arg0 = (*C.GstWebRTCRTPSender)(unsafe.Pointer(coreglib.BaseObject(sender).Native()))
